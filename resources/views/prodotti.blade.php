        ...
        <div class="cards">
            @foreach ($lunghe as $key => $card)
                <div class="card">
                    ...
                    <div class="links">
                        <h3><a href="{{route('prodotto', $key)}}">{{$card['titolo']}}</a></h3>
                        <a href="{{route('prodotto', $key)}}"><svg class="mk-svg-icon" data-name="mk-li-food" data-cacheid="icon-5eabe39c707e5" style=" height:32px; width: 32px; " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
